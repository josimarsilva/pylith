...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0v_gravbodyforce(const PylithInt dim,
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0v_grav(const PylithInt dim,
                                                                  const PylithInt numS,
                                                                  const PylithInt numA,
                                                                  const PylithInt sOff[],
                                                                  const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0v_bodyforce(const PylithInt dim,
                                                                       const PylithInt numS,
                                                                       const PylithInt numA,
                                                                       const PylithInt sOff[],
                                                                       const PylithInt sOff_x[],
 ...
 */
void
pylith::fekernels::IsotropicLinearPoroelasticity::stress(const PylithInt dim,
                                                                const PylithInt numS,
                                                                const PylithInt numA,
                                                                const PylithInt sOff[],
                                                                const PylithInt sOff_x[],
 ...
 */
void
pylith::fekernels::IsotropicLinearPoroelasticity::stress_refstate(const PylithInt dim,
                                                                         const PylithInt numS,
                                                                         const PylithInt numA,
                                                                         const PylithInt sOff[],
                                                                         const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0p_sourceDensity_gravbody(const PylithInt dim,
                                                                       const PylithInt numS,
                                                                       const PylithInt numA,
                                                                       const PylithInt sOff[],
                                                                       const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0p_sourceDensity_grav_body(const PylithInt dim,
                                                                       const PylithInt numS,
                                                                       const PylithInt numA,
                                                                       const PylithInt sOff[],
                                                                       const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0p_sourceDensity(const PylithInt dim,
                                                                       const PylithInt numS,
                                                                       const PylithInt numA,
                                                                       const PylithInt sOff[],
                                                                       const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::g0e_trace_strain(const PylithInt dim,
                                                             const PylithInt numS,
                                                             const PylithInt numA,
                                                             const PylithInt sOff[],
                                                             const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::Jg0ee(const PylithInt dim,
                                                const PylithInt numS,
                                                const PylithInt numA,
                                                const PylithInt sOff[],
                                                const PylithInt sOff_x[],
...
void
pylith::fekernels::IsotropicLinearPoroelasticity::Jg1eu(const PylithInt dim,
                                                const PylithInt numS,
                                                const PylithInt numA,
                                                const PylithInt sOff[],
                                                const PylithInt sOff_x[],
