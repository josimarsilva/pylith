...
\newcommand{\eqnannotategovern}[2]{%
  {\color{red}%
  \underbrace{\color{black}#1}_{\color{red}\mathclap{#2}}}}
  
\newcommand{\eqnannotaterheo}[2]{%
  {\color{green}%
  \underbrace{\color{black}#1}_{\color{green}\mathclap{#2}}}}
