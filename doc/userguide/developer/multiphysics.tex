...
\eqnannotate{\left(\nabla \cdot \vec{u} - 
\epsilon_{v} \right)}{g_{0}^{\epsilon_{v}} 
\ d\Omega
\end{align} \\
...
\eqnannotate{\left(t_{shift} \alpha \right)}{J_{f0}^{p\epsilon_{v}}} 
...
\psi_{trial}^{\epsilon_{v}} 
\eqnannotate{\left(\delta_{ij}\right)}{J_{g1}^{\epsilon_{v}u}} \psi_{basis 
i,j}^u \ 
d\Omega\\
%
...
\eqnannotate{\gamma(\vec{x},t)}{g_0^p} + \nabla \psi_{trial}^p \cdot 
