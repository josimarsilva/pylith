...
F^p}{\partial \dot{p}} = \int_{\Omega} \psi_{trial}^p (t_{shift} \frac{1}{M}) 
\psi_{basis}^p \ d\Omega = \int_{\Omega} \psi_{trial}^p (J_{f0}^{pp}) 
...
\bigtriangledown . \psi_{basis}^p) \ d\Omega = \int_{\Omega} \psi_{trial,k}^p 
(-\kappa \delta_{kl}) \psi_{basis,l}^p \ d\Omega \\
&= \int_{\Omega} \psi_{trial,k}^p (J_{g3}^{pp}) \psi_{basis,l}^p \ d\Omega \\
%
